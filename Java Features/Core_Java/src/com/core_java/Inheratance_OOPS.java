...
//		cal3.div(4, 5); // error compile
		...
		AddvanceCal addvanceCal2 = new AddvanceCal(); // because this method give all properties of parent class
		addvanceCal2.add(3, 4);
		addvanceCal2.sub(3, 4);
		addvanceCal2.mul(3, 4);
		addvanceCal2.div(3, 4);
