...
//		C1 c1 = new B1() // THis line giving an error because, we are creating reference of child and object of parent so this is not possible in java
//		c1.show();
		
		//And this is only work with inheritance
